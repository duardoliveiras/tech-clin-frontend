  ...
  return (
    <div className="flex h-screen bg-gray-100">
      <div className="w-64 bg-gray-200 p-4 flex flex-col space-y-4">
        <button className="py-2 px-4 bg-gray-300 text-gray-700">Clinica</button>
        <button className="py-2 px-4 bg-blue-400 text-white">Médico</button>
        <button className="py-2 px-4 bg-gray-300 text-gray-700">
          Gerar Horários
        </button>
      </div>
